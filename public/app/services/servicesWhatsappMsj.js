app.service('ApiService', function ($http) {
    ...
    this.obtenerMSJ = (q) => {
        return $http.post('https://941b-54-208-78-74.ngrok.io/api/cloud/get/whatsapp/msj', { query: q}).then((response) => {
            return response.data;
        })
            .catch((error) => {
                return null;
    ...
    this.obtenerMSJFiltro = (q) => {
        return $http.post('https://941b-54-208-78-74.ngrok.io/api/cloud/get/whatsapp/msj/filtro', { query: q }).then((response) => {
            return response.data;
        })
        .catch((error) => {
            return null;
    ...
    this.obtenerConteoMSJ = (userId) => {
        return $http.get('https://941b-54-208-78-74.ngrok.io/api/cloud/get/whatsapp/msj/conteo').then((response) => {
            return response.data;
        })
        .catch((error) => {
            console.log(error);
    ...
    this.obtenerConteoMSJFilter = (q, field) => {
        return $http.get('https://941b-54-208-78-74.ngrok.io/api/cloud/get/whatsapp/msj/conteo/filtro?q=' + q + '&field=' + field).then((response) => {
            return response;
        })
        .catch((error) => {
            console.log(error);
    ...
    this.obtenerQueueId = (queue) => {
        return $http.get('https://941b-54-208-78-74.ngrok.io/api/cloud/get/whatsapp/queueId?queue=' + queue).then((response) => {
            return response.data;
        })
            .catch((error) => {
                console.log(error);
    ...
    this.downloadReportMSJ = (ids) => {
        return $http.post('https://941b-54-208-78-74.ngrok.io/api/cloud/get/whatsapp/msj/download', { "ids": ids }).then((response) => {
            return response.data;
        })
            .catch((error) => {
                console.log(error);
