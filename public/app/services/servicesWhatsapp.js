app.service('ApiService', function ($http) {
    ...
    this.obtenerHSM = (q) => {
        return $http.post('https://ma2tskinym.us-east-1.awsapprunner.com/api/cloud/get/whatsapp/hsm', { query: q}).then((response) => {
            return response.data;
        })
            .catch((error) => {
                return null;
    ...
    this.obtenerHSMFiltro = (q) => {
        return $http.post('https://ma2tskinym.us-east-1.awsapprunner.com/api/cloud/get/whatsapp/hsm/filtro', { query: q }).then((response) => {
            return response.data;
        })
        .catch((error) => {
            return null;
    ...
    this.obtenerConteoHSM = (userId) => {
        return $http.get('https://ma2tskinym.us-east-1.awsapprunner.com/api/cloud/get/whatsapp/hsm/conteo').then((response) => {
            return response.data;
        })
        .catch((error) => {
            console.log(error);
    ...
    this.obtenerConteoHSMFilter = (q, field) => {
        return $http.get('https://ma2tskinym.us-east-1.awsapprunner.com/api/cloud/get/whatsapp/hsm/conteo/filtro?q=' + q + '&field=' + field).then((response) => {
            return response;
        })
        .catch((error) => {
            console.log(error);
    ...
    this.downloadReportHSM = (ids) => {
        return $http.post('https://ma2tskinym.us-east-1.awsapprunner.com/api/cloud/get/whatsapp/hsm/download', { "ids": ids }).then((response) => {
            return response.data;
        })
            .catch((error) => {
                console.log(error);
